...
/**
 * 获取并解密 ijrsoftware GPU-L 数据库数据
 *
 * @author Dr (dr@der.kim)
 * @date 2025/3/22 10:38
 */
public class GpuLDataJson {
    public static void main(String[] args) throws Exception {
        // MD5 hash of the string "com.ijsoft.gpul"
        byte[] bytes = md5("com.ijsoft.gpul").getBytes();
        ...
        try (CipherOutputStream cipherOut = new CipherOutputStream(out, cipher)) {
            // 这个 URL 来自 : https://www.ijrsoftware.com/json/db_gpus.json
            String str = new String(doGetRequestForFile("https://www.ijrsoftware.com/json/db_gpus.json"));
            if (str.isEmpty()) {
                throw new Exception("db_cpus.json is empty");
            }
            LinkedHashMap<String, Object> json = (LinkedHashMap<String, Object>) JSONSerializer.deserialize(str);
            System.out.println("Data Release " + json.get("release"));
            System.out.println("Data version " + json.get("version"));
        ...
        System.out.println("OK, Json(ZIP) File: "+ new File("/de-assets.zip").getAbsolutePath());
    }
